...
# test client to help understand the functionality and
# performance of the Simp.Data rabbit service
...
for (my $x = 0; $x < $n; $x++)
{
    $start   = gettimeofday();
    $results = $client->get(
        ipaddrs => ["156.56.6.103", "156.56.6.108"],
...
#oidmatch  =>  "1.3.6.1.2.1.4.35.1.4.*"
        oidmatch => "1.3.6.1.2.1.2.2.1.2.*",    #"1.3.6.1.2.1.2.2.1.2.*"
                                                #1.3.6.1.2.1.2.2.1
    );
